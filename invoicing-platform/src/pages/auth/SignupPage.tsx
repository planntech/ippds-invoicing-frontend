  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-50 to-gray-100 p-4">
      <div className="w-full max-w-2xl">
          ...
          <CardContent className="pt-6">
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                {/* Last Name */}
                <div className="space-y-2">
                  <Label htmlFor="last-name" className="text-gray-700 font-medium text-sm">
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <Input
                    ...
                    className="pl-10 pr-10 h-11 border-gray-300 focus:border-[#2f2d77] focus:ring-[#2f2d77]"
                    required
                  />
                  <button
                    type="button"
              ...
              <div className="flex items-start space-x-2">
                <input
                  id="terms"
                  type="checkbox"
                  className="h-4 w-4 mt-1 rounded border-gray-300 text-[#2f2d77] focus:ring-[#2f2d77]"
                  required
                />
                <label htmlFor="terms" className="text-sm text-gray-600">
                  I agree to the{' '}
                  <a href="/terms" className="font-medium text-[#2f2d77] hover:text-[#1f1d57]">
                    Terms of Service
                  </a>{' '}
                  and{' '}
                  <a href="/privacy" className="font-medium text-[#2f2d77] hover:text-[#1f1d57]">
                    Privacy Policy
                  </a>
                </label>
              </div>
            ...
            <div className="mt-6 text-center">
              <p className="text-sm text-gray-600">
                ...
                <a
                  href="/login"
                  className="font-medium text-[#2f2d77] hover:text-[#1f1d57] transition-colors"
                >
                  Sign in
                </a>
              </p>
        ...
        <div className="mt-6 text-center">
          <p className="text-xs text-gray-500">
            © 2026 IP Payment Solutions. All rights reserved.
          </p>
          <div className="mt-2 space-x-4 text-xs text-gray-500">
            <a href="#" className="hover:text-[#2f2d77] transition-colors">
              Terms
            </a>
            <span>•</span>
            <a href="#" className="hover:text-[#2f2d77] transition-colors">
